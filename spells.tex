...
Summons the full power of \linkto{religion:naga} and allows her to increase the power of the \linkto{items:falchion}, depending on the number of Gemstones present in the \linkto{items:fireemblem}:
\begin{enumerate}[(1)]
\item +1 greatsword
\item +2 greatsword
\item +3 greatsword
\item Dragons and undead are \textit{vulnerable} to this weapon
\item Power to seal away \linkto{religion:grima} for 1,000 years.
\end{enumerate}

*Requires the \linkto{items:fireemblem} and \linkto{items:falchion}
